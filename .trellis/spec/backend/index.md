...
| [Code Smell Prevention](./code-smell-prevention.md) | 弱类型禁用、SRP、防腐层、静默跳过反模式、历史违规修正义务 |
...
- **Refactor / cleanup tasks**: `code-smell-prevention.md`
...
- **Dependency / build config change**: Also read `../guides/build-dependency-governance-guide.md`

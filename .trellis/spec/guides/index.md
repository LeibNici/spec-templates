...
| [Git Workflow](./git-workflow.md) | 分支模型、Conventional Commits、PR 规范、Merge 策略 | 团队 ≥ 2 人协作；新人 onboarding |
| [i18n Strategy](./i18n-strategy.md) | 国际化策略：vue-i18n + Spring MessageSource + 字典 + 错误响应 | 项目要支持英文/多语言；新建用户可见文案 |
